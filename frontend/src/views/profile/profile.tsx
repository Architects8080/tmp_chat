          ...
          <div className="profile-header">
            <div className="profile-info">
              ...
              <div className="profile-description">
                ...
                <div className="profile-gameInfo">
                  <div className="ladder-rank">Ladder Rank : #1 (0.1% of top)</div>
            ...
            <div className="profile-side">
              <div className="profile-searchbar">
                {/* keyevent */}
                <img className="search-icon" alt="search-icon" src="/icons/searchbar/search.svg"/>
                <input className="search-nickname" type="text" placeholder={"search"}/>
              </div>
